...
// cria um elemento e é chamada na função 
...
async function requestProductMlb(product) {
  ...
  for (let index = 0; index < infosComputer.length; index += 1) {
    const elementCreated = createProductItemElement(infosComputer[index]);
